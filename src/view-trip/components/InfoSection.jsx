...
function InfoSection({trip}) {
  ...
  return (
    <div>   
        <img src={photoUrl ? photoUrl : '/public/road-trip-vacation.avif'}  className= 'h-[330px] w-full object-cover rounded-xl' /> 
        <div className='flex justify-between items-center'>
          <div className='my-6 flex flex-col gap-2'>
            <h2 className='font-bold text-2xl'>{trip?.userSelection?.location?.county}</h2>
